    ...
    public partial class FaturaGiris : MetroFramework.Forms.MetroForm
    {
        ...
        public void Send()
        {
            if (cmb_durum.Checked)
            {
                if (rbGelen.Checked)
                {
                    db.InsertFaturaGiris(Convert.ToString(txt_fatura_no.Text), Convert.ToString(cmb_projeNo.Text), Convert.ToString(cmb_firma.Text), Convert.ToInt32(txt_ftr_vade.Text), Convert.ToDateTime(date_alarm.Value), Convert.ToString(rcb_aciklama.Text), Convert.ToDateTime(date_ftr_tarih.Value), ck_alarm.Checked, Convert.ToDecimal(txt_ftr_tutar.Text), Convert.ToString(cmb_birim.Text), Convert.ToInt32(txt_avans.Text), fatura_euro, fatura_dolar, fatura_tl, Convert.ToString('G'), Convert.ToString(cmb_ftr_tip.Text), Convert.ToString("ODENDI"), Convert.ToString(cmb_se.Text));
                }
                if (rbKesilen.Checked)
                {
            ...
            else
            {
                if (rbGelen.Checked)
                {
                    db.InsertFaturaGiris(Convert.ToString(txt_fatura_no.Text), Convert.ToString(cmb_projeNo.Text), Convert.ToString(cmb_firma.Text), Convert.ToInt32(txt_ftr_vade.Text), Convert.ToDateTime(date_alarm.Value), Convert.ToString(rcb_aciklama.Text), Convert.ToDateTime(date_ftr_tarih.Value), ck_alarm.Checked, Convert.ToDecimal(txt_ftr_tutar.Text), Convert.ToString(cmb_birim.Text), Convert.ToInt32(txt_avans.Text), fatura_euro, fatura_dolar, fatura_tl, Convert.ToString('G'), Convert.ToString(cmb_ftr_tip.Text), Convert.ToString("ODENMEDI"), Convert.ToString(cmb_se.Text));
                }
                if (rbKesilen.Checked)
                {
